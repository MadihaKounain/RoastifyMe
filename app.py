...
with st.sidebar:
    ...
    st.markdown("""
        ...
        🔥 Choose your vibe  
        🎙 Get it read out loud  
        🪞 Try Mirror Mode  
        🎲 Random Surprise awaits! 
    """)
    st.markdown("---")
    st.info("Made with ❤ by Madiha the Savage 👸")
...
with st.container():
    ...
    st.caption("⬅ Grumpy | Neutral 😶 | Happy ➡")
...
# Sassy and Dramatic
    ...
    "https://media.giphy.com/media/xUPGcgtKxm4PADy3Ck/giphy.gif",    # Savage snap 💁‍♀
    ...
    "https://media.giphy.com/media/fWg6nqV7aR7y3Z4Fwj/giphy.gif",    # Feeling spicy 🌶
...
# 👣 Footer
st.markdown("---")
st.caption("Made with fire & love 🔥💖 by Madiha")